...
Lecture notes for a course on Systems Thinking, hosted at
<https://d-morrison.github.io/systems/>.
...
publishes the website to GitHub Pages when you push to the main branch.
...
Automatically builds and deploys the website to GitHub Pages when you
push to the main branch.

### 🔍 PR Preview Workflow (`preview.yml`)

Creates a preview deployment for pull requests with change detection and
highlighting.
...
Validates that all books and articles in bibliography files have DOI
fields that resolve correctly.
